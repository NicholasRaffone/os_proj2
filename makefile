...
primes: helpers.o prime_algorithms.o primes.o delegator worker.o 
	gcc primes.o helpers.o prime_algorithms.o -o primes && gcc delegator.o helpers.o prime_algorithms.o -o delegator && gcc worker.o prime_algorithms.o -o worker

primes.o: primes.c primes.h helpers.o
	gcc -c primes.c

delegator: delegator.o helpers.o
	gcc delegator.o helpers.o prime_algorithms.o -o delegator

delegator.o: delegator.c delegator.h helpers.o
	gcc -c delegator.c

worker: worker.o prime_algorithms.o
	gcc worker.o prime_algorithms.o -o worker
